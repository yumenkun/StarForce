...
namespace KEngine
{
    public class KEngineDef
    {
        ...
        /// </summary>
        public const string ResourcesEditDir = "Art";
        ...
        private static bool useLuaCache = true;
        public static bool UseLuaCache { get { return useLuaCache; } set { useLuaCache = value; } }
    }
}
