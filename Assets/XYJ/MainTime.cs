...
//    }
//    //服务器时间，从2000年起的秒数
//    static public int curServTick{get{ return ToTick(curServDateTime);}
//    }
//
...
//        {
//            Utils.TimerManage.DelTimer(s_midnightTimeId);
//            s_midnightTimeId = 0;
//        }
...
//        if (s_pause == 0)
//        {
//            Utils.EventDispatcher.Instance.TriggerEvent<bool>(EventDefine.SceneEvents.PauseGame, true);
//        }
//        s_pause++;
//    }
//
//    //恢复游戏，需要确保任何时候都要配对调用，包含突然切换场景的情况
//    static public void ResumeGame()
//    {
//        s_pause--;
//        if (s_pause == 0)
//        {
//            Utils.EventDispatcher.Instance.TriggerEvent<bool>(EventDefine.SceneEvents.PauseGame, false);  
//        }
//    }
//
//
